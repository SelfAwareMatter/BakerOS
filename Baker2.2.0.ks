  ...
  function rovercontrol
  {
    function rovercontrolmain 
    {
      ...
      function bakerlandgui
      {
        ...
        print "|          |   BAKER ROVER CONTROL v2.2.0                    - 0 X |           |" at (0,2).
        print "|          |¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯|           |" at (0,3).
        print "|          |                                                       |           |" at (0,4).
        print "|          |                                                       |           |" at (0,5).
        print "|          |                                                       |           |" at (0,6).
...
function blackjack
{
    ...
    {
    print "#########################################################|  EXIT  |############|".
    print "|   Dealer:         __________________          BLACKJACK v2.2.0               |".
    ...
    {
    print "#########################################################|  EXIT  |############|".
    print "|   Dealer:       | _______________|__          BLACKJACK v2.2.0               |".
...
function Bakerlaunch
{
  ...
  function Stagemenu
  {
    function stagemenugui
    {
        print "################################################################################".
        print "|______________________________________________________________________________|".
        print "||  BAKER OS v2.2.0          Baker Launch Program                        - 0 X||".
        print "||¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯||".
        print "||    Launch Menu...                                                          ||".
        print "||                                                                            ||".
        print "||      Stages:                                                               ||".
        ...
        print "||      Discard stage at 65k?:                                                ||".
        print "||      Velocity to start gravity pitch:                                      ||".
        print "||                                                                            ||".
        print "||                                                                            ||".
        print "||                                                                            ||".
  ...
  function Inclinationmenu
  {
    //inclinationmenugui().
      ...
      until false
      {
        print RelativeInclination at (29,8).
        set ch to terminal:input:getchar().
        if ch = terminal:input:DOWNCURSORONE 
        {
  ...
  function Pitchstartvelocitymenu
  {
    ...
    //pitchmenugui().
      ...
      until false
      {
        print pitchstartvelocity + "  " at (42,10).
        set ch to terminal:input:getchar().
        if ch = terminal:input:DOWNCURSORONE 
        {
  ...
  function AsscentControl
  {
    ...
    when TargetV < ship:velocity:orbit:mag then
    {
      print "Asscent Control shutdown Target Velocity..." at (45,12).
      set throt to 0.
      set h to 2.
    }
    ...
    when newthtw - oldthtw > 0 then
    {
      if nos > 0 and ship:altitude > 500
      {
        V0:PLAY(NOTE(440,0.5)).
        set nos to (nos - 1).
        Print "Thrust to weight Staging..." at (8,10).
        Print "Stages left... " + nos at (8,8).
        stage.
        return true.
      }
    ...
    when ship:velocity:surface:mag > pitchstartvelocityx then
    {
      if ooo = 1
      {
        print "Starting Gravity turn..." at (8,9).
        set ooo to 2.
    ...
    when ship:apoapsis > targetapkm and ship:verticalspeed > 0 then
    {
      lock steering to horizon4.
      lock throt to testthrot.
    }

    when ship:apoapsis > (targetap*1000)*.1 + targetap*1000 then
    {
      print "Asscent Control shutdown Apo too high..." at (45,12).
      lock throt to 0.
      set h to 2.
      wait 3.
    }

    when ship:periapsis > targetap*1000 then
    {
      print "Asscent Control shutdown Peri too high..." at (45,12).
      set throt to 0.
      set h to 2.
    }
    ...
    when ship:apoapsis > targetap*1000 and ship:periapsis > targetapkm then
    {
    ...
    when periapsis > 65000 and trasha = 1 then
    {
      set throt to 0.
      wait 1.
      rcs on.
    ...
    { 
      ...
      print "Ship Apoapsis:" + round(ship:apoapsis) at (8,12).
      print "Ship Periapsis:" + round(ship:periapsis) at (8,11).
    }
  }
  function Shutdownlaunch
  {
    ...
    {
      lock throttle to 0.
      print "Remaining Stage Staging." at (45,13).
      stage.
      set nos to nos - 1.
    }
    print "Launch nominal:                   " at (8,9).
    print "Ship Apoapsis:" + ship:apoapsis at (8,12).
    print "Ship Periapsis:" + ship:periapsis at (8,11).
    print "Burn Accuracy:" + round((ship:periapsis/ship:apoapsis)*100,2) at (8,7).
    wait 3.
    unlock throttle.
  }
  launchv1().
...
function bakerexecnode
{
  if hasnode 
  {
    ...
    function exenodegui
    {
      ...
      print "|          |   BAKER OS v2.2.0                               - 0 X |           |".
      print "|          |¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯|           |".
      print "|          |               Baker Execute Node v2.2.0               |           |".
      print "|          |                                                       |           |".
      print "|          |                                                       |           |".
      print "|          |                                                       |           |".
      print "|          |                                                       |           |".
...
function bakercircleap
{
  ...
  until isdone > 0
  {
    if running = true
    {
      ...
      print " Burntime: "+round(burntime)+"s                 " at (13,11).
      Print " Burn DeltaV: "+burndeltav+"               " at (13,12).
      print " Apoapsis: "+round(apoapsis)+" m            " at (13,7).
      print " Periapsis: "+round(periapsis)+" m                 " at (13,9).
...
function bakertimewarp
{
  ...
  function warptomain {
    ...
    until isDone > 0 {
      ...
      //Print UI elements
      PRINT "HELP      |-5SECS    |+5SECS    |       VULCAN TIMEWARP CONTROL   v2.2.0    |" at (0,0).
...
function bakeros
{
  ...
  function printscreen8
  {
    ...
    print "|          |     72. Land v2.2.0      73. Transfer Menu            |           |".
...
function desktop
{
  ...
  function print1
  {
    ...
    print "|     Main           Main            20             50             80          |".
    print "|                                                                              |".
    print "|    _______        _______        _______        _______        _______       |".
    print "|    |_____|        |_____|        |_____|        |_____|        |_____|       |".
    print "|     Main           Main            10             40             70          |".
    print "|                                                                              |".
    print "|    _______        _______        _______        _______        _______       |".
    print "|    |_____|        |_____|        |_____|        |_____|        |_____|       |".
    print "|     Main           Main           Main            30             60          |".
    print "|                                                                              |".
    print "|                                                                              |".
    print "|                                                                              |".
    print "|______________________________________________________________________________|".
